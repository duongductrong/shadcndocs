---
title: Introduction
description: Base on shadcn/ui, shadcn-docs is a documentation template for building beautiful documentation sites with Next.js and MDX.
---
...
The shadcn/docs is designed to be easily customizable. You can change the code to fit your needs.
